...
bench_info = {
        ...
        "WRITE_PART_CYCLES"     :   "WRITE_PART_CYCLES",
        "ALLOC"                 :   "ALLOC",
        "ALLOC_CYCLES"          :   "ALLOC_CYCLES",
        "ZALLOC"                :   "ZALLOC",
        "ZALLOC_CYCLES"         :   "ZALLOC_CYCLES",
        "FREE"                  :   "FREE",
        "FREE_CYCLES"           :   "FREE_CYCLES",
        "UNDO_LOG"              :   "UNDO_LOG",
        "UNDO_LOG_CYCLES"       :   "UNDO_LOG_CYCLES",
        "REDO_LOG"              :   "REDO_LOG",
        "REDO_LOG_CYCLES"       :   "REDO_LOG_CYCLES",
        "MANIFEST_LOG"          :   "MANIFEST_LOG",
        "MANIFEST_LOG_CYCLES"   :   "MANIFEST_LOG_CYCLES",
        "ENCRYPTION_COST"       :   "ENCRYPTION_COST",
        "ENCRYPTION_COST_CYCLES":   "ENCRYPTION_COST_CYCLES",
        "TX"                    :   "TX",
        "TX_CYCLES"             :   "TX_CYCLES",
        "LOOKUP"                :   "LOOKUP",
...
def analyse(filtered_results, plot_config, info_idx, labels_idx, values_idx) -> None:
    ...
    y_label = metrics[y_axis]
    x_label = bench_info[x_axis]
    y_values = {}
    x_values = {}
    info = {}
